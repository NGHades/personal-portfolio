...
**Things I Learned**:
An evergreen, non-technical log page. Replaces the earlier "Now" idea — there is no separate Now page. Contains the Watched/Rewatched and On Repeat (music) subsections.
...
**Nav (final)**:
Home, About Me, Projects, Things I Learned, Visitor Gallery, Resume.
